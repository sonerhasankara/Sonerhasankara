...
for(let i=0; i<70; i++){
      hst.innerHTML += '<div class="col mb-5"> <div class="card h-100"><a class="btn" href="#0" onclick = "reply_click(this.id)" id="'+data[i].audio_list+'"><img class="card-img-top" src="'+data[i].image+'" /></a>'+
